...
Physical perils produce damage that can be quantified using historical data.  Incorporating data on an assets economic function and strucutral fucntion, we can get even more precise financial risk estimates.  Currently, Sust Global focuses on two forms of financial risk analysis (sometimes referred to as Value-at-Risk or VaR):
