...
**lat** | **float** | Latitude of the asset | [optional] 
**lng** | **float** | Longitude of the asset | [optional] 
**geometry** | **bool, date, datetime, dict, float, int, list, str, none_type** | Geometry of a Polygon | [optional] 
