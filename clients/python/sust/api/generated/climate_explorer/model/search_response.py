...
class SearchResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'features': ([SearchResponseFeature],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, features, geometry, *args, **kwargs):  # noqa: E501
        """SearchResponse - a model defined in OpenAPI

        Args:
            type (str): Type of the response generated by the search API
            features ([SearchResponseFeature]): List of features returned by the search API
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, features, geometry, *args, **kwargs):  # noqa: E501
        """SearchResponse - a model defined in OpenAPI
