...
class PhysicalRiskDatasetItemResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, portfolio_name, portfolio_index, entity_id, entity_name, hazard, indicator, measure, risk_exposure, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, portfolio_name, portfolio_index, entity_id, entity_name, hazard, indicator, measure, risk_exposure, *args, **kwargs):  # noqa: E501
        """PhysicalRiskDatasetItemResponse - a model defined in OpenAPI
